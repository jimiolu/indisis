...
const CustomSoftware = () => {
  return (
    <div>
      <Container>
        <div className="py-20 space-y-10 text-baseColor">
          <h3 className="text-3xl md:text-4xl lg:w-[40%] leading-tight">
            Custom Software Development Solutions Expertise
          </h3>
          <div className="space-y-5">
            <p className="text-sm md:text-lg lg:w-[40%] text-gray-500">
